...
// ---------------- WIFI ----------------
const char* ssid = "CLUB_LOLITA";
const char* password = "chimulandia";
...
static const int MAX_STAGES = 14;
static const int MAX_SEGS = 180;
    ...
    <div id="view-race" class="view active">
        ...
        <div style="padding: 10px; background: #1a1a1a; border-top: 2px solid #333;">
            <div style="margin-bottom: 10px;">
                <button id="btnStart" class="btn-main btn-start" onclick="startRace()">GAS A FONDO!!!</button>
                <button id="btnStop" class="btn-main btn-stop" onclick="pauseRace()">PAUSAR</button>
                <button class="btn-main" onclick="confirmReset()" style="background:#444;">RESET</button>
            </div>
...
function confirmReset() {
  if (confirm("¿Seguro que quieres reiniciar el tramo?")) {
    resetAll();
  }
}
